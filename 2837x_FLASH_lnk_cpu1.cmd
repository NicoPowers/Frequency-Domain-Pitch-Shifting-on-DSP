...
PAGE 1 : /* Data Memory */
   ...
   RAMGS       : origin = 0x00C000, length = 0x00FFF8
...
SECTIONS
{
   ...
   windowedInputBlock : > RAMGS, PAGE = 1, ALIGN(1024) // input into FFT
   ...
   CFFTinBuff : > RAMGS, PAGE = 1, ALIGN(2048) // input to IFFT
